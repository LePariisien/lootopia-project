...
export class ShopComponent {
  ...
  crownPacks = [
    { title: 'Pack Découverte', sub: "Pour débuter l'aventure", amount: 100, price: '4,99 €', priceValue: 4.99, oldPrice: '5,24€', discount: '-5%' },
    { title: 'Pack Aventurier', sub: 'Le plus populaire', amount: 300, price: '12,99 €', priceValue: 12.99, oldPrice: '14,97 €', discount: '-10%' },
    { title: 'Pack Explorateur', sub: 'Pour les passionnés', amount: 600, price: '29,99 €', priceValue: 29.99, oldPrice: '37,50 €', discount: '-20%', badge: 'MEILLEURE OFFRE', bonus: '+100' },
    { title: 'Pack Trésorier', sub: 'Pour les collectionneurs', amount: 2000, price: '69,99 €', priceValue: 69.99, oldPrice: '100,00 €', discount: '-30%', bonus: '+500' }
  ];
